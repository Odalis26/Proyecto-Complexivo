  ...
  <div class="container" style="background-color:#FFFFFF; position:relative; width:1170px; left:200px">
    <div class="row">
      <div class="col-md-12">
        ...
        <a data-toggle="modal" href=".././botones/autores-administrador/ver.php" class="btn btn-default">        <i class="bi bi-gear-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
