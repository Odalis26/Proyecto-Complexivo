       ...
       foreach ($usuarios as $key => $value){
          ...
          echo ' <tr>
                  ...
                  if($value["foto"] != ""){
                    ...
                    echo '<td><img src="'.$value["foto"].'" class="img-thumbnail" width="120px" style="border: 4px black solid;"></td>';

                  }else{

                    echo '<td><img src="vistas/img/usuarios/default/anonymous.png" class="img-thumbnail" width="120px" style="border: 4px black solid;"></td>';
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:black; color:white">
          ...
          <h4 class="modal-title" style="background:black;color:white;">Editar usuario</h4>
          ...
          <div class="box-body" style="background:white; color:white; border: 2px white solid;">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:white; color:black; border: 2px transparent solid;"><i class="fa fa-user"></i></span> 

                <input type="text" class="form-control input-lg" id="editarNombre" name="editarNombre" value="" style="border: 2px transparent solid;border-bottom: 2px black solid;background:white;color:black;" required>
            ...
            <!-- ENTRADA PARA EL USUARIO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:white; color:black; border: 2px transparent solid;"><i class="fa fa-key"></i></span> 

                <input type="text" class="form-control input-lg" id="editarUsuario" name="editarUsuario"  value="" style="border: 2px transparent solid;border-bottom: 2px black solid;background:white;color:black;" readonly>
            ...
            <!-- ENTRADA PARA LA CONTRASEÑA -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:white; color:black; border: 2px transparent solid;"><i class="fa fa-lock"></i></span> 

                <input type="password" class="form-control input-lg" name="editarPassword" placeholder="Escriba la nueva contraseña" style="border: 2px transparent solid;border-bottom: 2px black solid;background:white;color:black;">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon" style="background:white; color:black; border: 2px transparent solid;"><i class="fa fa-users"></i></span> 

                <select class="form-control input-lg" name="editarPerfil" style="border: 2px white solid;background:white;color:black;">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <input type="file" class="nuevaFoto" name="editarFoto" style="background:black; color:white; border: 2px black solid;">

              <p class="help-block">Peso máximo de la foto 2MB</p>

              <img src="vistas/img/usuarios/default/anonymous.png" style="background:black; color:black; border: 2px black solid;" class="img-thumbnail previsualizarEditar" width="130px">
        ...
        <div class="modal-footer" style="background:white; color:white; border: 2px white solid;">
          ...
          <button type="submit" class="btn btn-primary" style="background:#EBA401; color:white; border: 2px #EBA401 solid;"><b>Modificar usuario</b></button>
