...
<br><br><br><br><br>
  <div class="container" style="background-color:#FFFFFF; position:relative; width:1170px; left:200px">
    <div class="row">
      <div class="col-md-12">
        <h2> <b>AYUDA - AL CLIENTE</b> </h2>
        <!-- Button trigger modal -->
        <a data-toggle="modal" href=".././botones/ayuda-administrador/ver.php" class="btn btn-default">        <i class="bi bi-gear-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
