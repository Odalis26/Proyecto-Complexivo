          ...
          <tbody>
            ...
            foreach ($clientes as $key => $value) {
              ...
              if ($_SESSION["perfil"] == "Cliente") {
                ...
                echo '<a class="btn btn-outline-dark" href="http://localhost/proyecto-completo/botones/ayuda-cliente/ver.php"><i class="bi bi-question-square-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style="background:white; color:black;"fill="currentColor" class="bi bi-question-square-fill" viewBox="0 0 16 16">
